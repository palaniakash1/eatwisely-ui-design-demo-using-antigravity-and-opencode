...
import { Table, Badge, Button, TextInput, Label, Modal, Checkbox } from 'flowbite-react'
...
export default function DashCategories() {
  ...
  return (
    <DashboardLayout activeTab="categories" pageTitle="Categories">
      <DashboardHeader
        title="Categories"
              ...
              {paginatedCategories.length === 0 ? (
                ...
                paginatedCategories.map((category) => (
                  <Table.Row key={category._id} className="bg-white">
                    ...
                    <Table.Cell><code className="text-sm bg-gray-100 px-2 py-1 rounded">{category.slug}</code></Table.Cell>
                    ...
                    <Table.Cell>
                      <div className="flex items-center gap-2">
                        <Button size="xs" color="blue" onClick={() => openEditModal(category)}>
                          <HiPencil className="w-4 h-4" />
                        </Button>
                        <Button size="xs" color="failure" onClick={() => handleDeleteCategory(category._id)}>
