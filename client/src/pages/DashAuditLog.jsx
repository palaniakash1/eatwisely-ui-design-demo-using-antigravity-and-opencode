...
const defaultAuditLogs = [
  ...
  },
  {
    ...
    user: "admin",
    details: 'Created "The Green Kitchen"',
  ...
  },
  {
    ...
    action: "Update User",
    user: "admin",
    details: "Changed role to storeManager",
    ipAddress: "192.168.1.2",
  ...
  },
  {
    ...
    user: "admin",
    details: 'Removed "Old Dish" from menu',
    ipAddress: "192.168.1.2",
...
export default function DashAuditLog() {
  ...
  const filteredLogs = auditLogs.filter((log) => {
    ...
    const matchesAction =
      actionFilter.length === 0 || actionFilter.includes(log.action);
