...
const menuItems = [
  { id: 'dashboard', label: 'Dashboard', icon: FaHome, path: '/manager' },
  { id: 'profile', label: 'Profile', icon: FaUser, path: '/manager/profile' },
  { id: 'categories', label: 'Categories', icon: FaTags, path: '/manager/categories' },
  { id: 'menu', label: 'Menu', icon: FaList, path: '/manager/menu' },
  { id: 'reviews', label: 'Reviews', icon: FaStar, path: '/manager/reviews' },
]

const bottomMenuItems = [
  { id: 'settings', label: 'Settings', icon: FaCog, path: '/manager/settings' },
]
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <div className="lg:hidden bg-white border-b border-gray-200 p-4 flex items-center">
          ...
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-xs bg-[#8fa31e] text-white px-2 py-0.5 rounded">MANAGER</span>
          </Link>
        </div>
