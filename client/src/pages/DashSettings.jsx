...
export default function DashSettings() {
  ...
  return (
    <DashboardLayout activeTab="settings" pageTitle="Settings">
      <DashboardContent>
            ...
            <Card>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="allowRegistration" value="Allow User Registration" />
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="requireEmailVerification" value="Require Email Verification" />
                ...
                <div>
                  <Label htmlFor="maxRestaurants" value="Max Restaurants Per User" />
                  <TextInput 
                    id="maxRestaurants" 
                    type="number"
                    value={settings.maxRestaurantsPerUser} 
                    onChange={(e) => setSettings({...settings, maxRestaurantsPerUser: parseInt(e.target.value)})}
                  />
                </div>
              </div>
            </Card>
