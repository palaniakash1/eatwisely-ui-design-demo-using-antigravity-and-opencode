...
import { FaHome, FaStore, FaUsers, FaTags, FaList, FaStar, FaCog, FaScroll, FaSignOutAlt, FaBars, FaTimes, FaUser } from 'react-icons/fa'

const menuItems = [
  { id: 'dashboard', label: 'Dashboard', icon: FaHome, path: '/admin' },
  { id: 'profile', label: 'Profile', icon: FaUser, path: '/admin/profile' },
  { id: 'restaurant', label: 'My Restaurant', icon: FaStore, path: '/admin/restaurant' },
  { id: 'users', label: 'Store Managers', icon: FaUsers, path: '/admin/users' },
  { id: 'categories', label: 'Categories', icon: FaTags, path: '/admin/categories' },
  { id: 'menu', label: 'Menus', icon: FaList, path: '/admin/menu' },
  { id: 'reviews', label: 'Reviews', icon: FaStar, path: '/admin/reviews' },
  { id: 'auditlog', label: 'Audit Log', icon: FaScroll, path: '/admin/auditlog' },
]
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <div className="lg:hidden bg-white border-b border-gray-200 p-4 flex items-center">
          ...
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-xs bg-[#8fa31e] text-white px-2 py-0.5 rounded">ADMIN</span>
          </Link>
        </div>
