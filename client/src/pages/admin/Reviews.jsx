...
export default function AdminReviews() {
  ...
  useEffect(() => {
    ...
    if (storedReviews) {
      ...
      setReviews(defaultAdminReviews);
      localStorage.setItem("admin_reviews", JSON.stringify(defaultAdminReviews));
    }
  }, []);
    ...
    <div className="p-6">
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-4 border-b border-gray-200 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <h2 className="text-lg font-bold text-gray-800">Restaurant Reviews</h2>
