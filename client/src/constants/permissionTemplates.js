export const PRIVILEGED_ROLE_TEMPLATES = {
  superAdmin: {
    ...
    review: ['readAll', 'readById', 'moderate']
  },
  admin: {
    auth: ['signout', 'session', 'changePassword'],
    audit: ['read'],
...
export const PERMISSION_GROUPS = [
    ...
    permissions: [
      {
        ...
        description: 'View all users in the system including privileged users.'
      },
      {
      ...
      },
      {
        ...
        label: 'Create Admins',
        description: 'Create admin users from the dashboard.'
      },
      {
        key: 'user.createSuperAdmin',
        label: 'Create Super Admins',
        description: 'Create superAdmin users (highest privilege).'
      },
      {
        key: 'user.readPrivilegedUsers',
        label: 'View Privileged Users',
        description: 'Access to view admin and superAdmin user details.'
      },
      {
        key: 'user.updateAny',
        label: 'Update Any User',
        description: 'Modify any user account in the system.'
      },
      {
        key: 'user.deleteAny',
        label: 'Delete Any User',
        description: 'Permanently remove any user account.'
      },
      {
        key: 'user.deactivateAny',
        label: 'Deactivate Any User',
        description: 'Disable any user account.'
      },
      {
  ...
  },
  {
    ...
    permissions: [
      ...
      {
        key: 'restaurant.readAll',
        label: 'View All Restaurants',
        description: 'Browse all restaurants in the system.'
      },
      {
      ...
      {
        key: 'restaurant.readAudit',
        label: 'View Restaurant Audit',
        description: 'Inspect restaurant audit history.'
      }
    ]
  },
  {
    ...
    permissions: [
      {
        key: 'category.readAll',
        label: 'View All Categories',
        description: 'Browse all category records in the system.'
      },
      {
    ...
    permissions: [
      {
        ...
        description: 'Browse all menu records in the system.'
      },
      {
        key: 'menu.create',
        label: 'Create Menus',
    ...
    permissions: [
      {
        ...
        description: 'Read all reviews across the platform.'
      },
      {
        key: 'review.readById',
        label: 'View Reviews',
  ...
  },
  {
    ...
    permissions: [
      ...
      {
        key: 'audit.create',
        label: 'Create Audit Entries',
        description: 'Manually create audit log entries.'
      },
      {
        key: 'audit.update',
        label: 'Update Audit Entries',
        description: 'Modify existing audit log entries.'
      },
      {
        key: 'audit.delete',
        label: 'Delete Audit Logs',
        description: 'Remove audit log entries (data retention).'
      }
    ]
  }
];
